            ...
            onTap: () {
              BookingSource.addBooking(
                ...
                Booking(
                  ...
                  serviceFee: 60000,
                  activities: 40000,
                  totalPayment: hotel.price * 2 + 60000 + 40000,
                  status: 'PAID',
                  isDone: false,
                ),
              );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          itemRoomDetails(context, '1 night', AppFormat.currency(500000)),
          const SizedBox(height: 16),
          itemRoomDetails(context, 'Service fee', AppFormat.currency(60000)),
          const SizedBox(height: 16),
          itemRoomDetails(context, 'Activities', AppFormat.currency(40000)),
          const SizedBox(height: 16),
          itemRoomDetails(context, 'Total Payment', AppFormat.currency(600000)),
          const SizedBox(height: 16),
        ],
      ),
    );
